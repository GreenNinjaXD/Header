...
class Header {
    ...
    moveText() {
        ...
        const textMove = text.getBoundingClientRect();
        const x = Math.random() * (window.innerWidth - textMove.width);
        const y = Math.random() * (window.innerHeight - textMove.height);
...
const hd = new Header('.header__content');